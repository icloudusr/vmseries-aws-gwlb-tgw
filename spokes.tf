...
module "spk1_subnets" {
  ...
  subnets = {
    "vm-az1" = {
      ...
      cidr = var.spk1_cidr_vm_az1
    },
    "vm-az2" = {
      az   = data.aws_availability_zones.available.names[1]
      cidr = var.spk1_cidr_vm_az2
    },
    "alb-az1" = {
      az   = data.aws_availability_zones.available.names[0]
      cidr = var.spk1_cidr_alb_az1
    },
    "alb-az2" = {
      az   = data.aws_availability_zones.available.names[1]
      cidr = var.spk1_cidr_alb_az2
    },
    "gwlbe-az1" = {
      az   = data.aws_availability_zones.available.names[0]
      cidr = var.spk1_cidr_gwlbe_az1
    },
    "gwlbe-az2" = {
      az   = data.aws_availability_zones.available.names[1]
      cidr = var.spk1_cidr_gwlbe_az2
    }
  }
}
